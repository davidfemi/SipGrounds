...
module.exports.createCafe = async (req, res, next) => {
    ...
    const campground = new Cafe(req.body.campground)
...
module.exports.showCafe = async (req, res) => {
    const campground = await Cafe.findById(req.params.id).populate({
        path: 'reviews',
        populate: {
            path: 'author'
        }
...
module.exports.updateCafe = async (req, res) => {
    ...
    const campground = await Cafe.findByIdAndUpdate(id, { ...req.body.campground })
